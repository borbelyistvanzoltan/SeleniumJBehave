package travelledger.webdriver;
...
import travelledger.webdriver.steps.TravelledgerWebSteps;
...
public class TravelLedgerWebStories extends JUnitStories {
    ...
    protected List<String> storyPaths() {
        return new StoryFinder()
                .findPaths(codeLocationFromClass(this.getClass()).getFile(), asList("**/stories/*Login*.story"), null);
    }
