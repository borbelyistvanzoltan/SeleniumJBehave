...
Then Filter for "ER1234101" booking reference
Then Check that transaction status dropdown has proper elements for "ER1234101"
Then Click on the "ER1234101" transaction status which has blank status and select AMENDED status